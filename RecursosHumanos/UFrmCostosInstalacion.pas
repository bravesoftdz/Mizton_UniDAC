...
uses
  ...
  cxMaskEdit, cxCalendar, uconection, MemDS, DBAccess, Uni;
...
type
  TFrmCostosInstalacion = class(TFrmMiniCatalogo)
    ...
    dxLYCDatosGroup4: TdxLayoutAutoCreatedGroup;
    zTO: TUniQuery;
    dsTO: TDataSource;
...
procedure TFrmCostosInstalacion.FormShow(Sender: TObject);
begin
  inherited;
  AsignarSQL(zto, 'mt_tipoorden', preadOnly);
  FiltrarDataset(zTO, 'IdTipo', ['-1']);
