...
uses
  ...
  dxDockControl, dxBar, dxRibbon, dxLayoutContainer, dxLayoutControl, cxGridLevel, cxGridCustomView,
  ...
  ShellAPI, cxCurrencyEdit, uni, ZAbstractRODataset, ZAbstractDataset, ZDataset,
  DBAccess, MemDS;
...
type
  TFrmMaterialesxFolios = class(TForm)
    ...
    zConceptos: TUniquery;
    zDeleteFolio: TUniQuery;
    zUptMateriales: TUniUpdateSQL;
    zMaterial: TUniQuery;
...
begin
  try
    ...
    begin
      ...
      ExApp.Range['A2:Q2'] := 'PARÁMETROS ELÉCTRICOS';
      ...
      ExApp.Range['P4:Q5'] := 'DIAGNÓSTICOS';
...
begin
  if key = 13 then
  begin
    zUptMateriales.ModifySQL.Text := 'update mt_materialxfolio set cantidad='+zMaterial.FieldByName('Cantidad').AsString+' where idMaterialxfolio='+zMaterial.FieldByName('idMaterialxfolio').AsString;
    reconectar;
