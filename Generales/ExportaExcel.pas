...
uses
  ...
  Procedure FormatoTexto(Rango: Variant; Letra: String; tamano: Integer; Centrar: Boolean; Negrita: Boolean = False);
...
Procedure FormatoTexto(Rango: Variant; Letra: String; tamano: Integer; Centrar: Boolean; Negrita: Boolean = False);
begin
  Rango.font.name := Letra;
  Rango.font.Size := Tamano;
...
procedure SetBorders(Rango: Variant; Grosor,
  Tipo: integer);
begin
  //Bordes
