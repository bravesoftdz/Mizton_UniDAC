  ...
  try
    ...
    try
      ...
      begin
        ...
        Server := VarRegistry('\Settings','\'+ defaultConnectionName +'', 'Host');
        UserName := VarRegistry('\Settings','\'+ defaultConnectionName +'', 'MysqlUser');
...
//      end;
      ...
      try
        ...
        begin
          Database := '';
          Server := VarRegistry('\Settings','\'+ cbbDireccionesIP.Text +'', 'Host');
          UserName := VarRegistry('\Settings','\'+ cbbDireccionesIP.Text +'', 'MysqlUser');
...
begin
  try
    try
      ...
      UDMConection.conBD.UserName := VarRegistry('\Settings','\' + defaultConnectionName + '', 'MysqlUser');
      ...
      UDMConection.conBD.ProviderName := VarRegistry('\Settings','\' + defaultConnectionName + '', 'MysqlProtocol');
...
begin
  try
    try
      Result := False;
      zUsuario := TUniquery.Create(Self);
