...
uses
  ...
  dxCustomHint, cxHint, MemDS, DBAccess, Uni;
...
type
 ...
 End;
  ...
  TFrmAEmpresas = class(TFrmCatalogo)
    ...
    zCatalogoImpuestos: TUniQuery;
    dsCatalogoImpuestos: TDataSource;
    zImpuestosSeleccionados: TUniQuery;
    ...
    zImpuestosSeleccionadosUpt: TUniQuery;
    zImpConsulta: TUniQuery;
