...
uses
  ...
  cxClasses, cxLookupEdit,
  cxDBLookupEdit, cxDBLookupComboBox, uni, MemDS, DBAccess;
...
begin
  ...
  SetRegistry('\Settings','\' + cxTextNombreCOn.Text + '', 'SkinName', 'DevExpressStyle');
  ...
  try
    ...
    try
      ...
      try
        ...
        begin
          Database := '';
          Server := cxTextHost.Text;
          UserName := cxTextUsuario.Text;
