...
uses
  ...
  cxGridExportLink, ShellAPI, cxSplitter, uni, MemDS, DBAccess, CRAccess;
...
begin
  ...
  Estado := (zDatos.Active) and (zDatos.RecordCount > 0) and (zDatosUpt.State = dsBrowse);
    ...
    try
      ...
      begin
        ...
        begin
          ...
          Tabla := TCRFieldDesc(zDatosUpt.GetFieldDesc(zDatosUpt.Fields[0].FieldNo)).TableInfo.TableName; //getTableName//gettableName
          Lista.Delimiter := ',';
