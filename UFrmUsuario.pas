...
uses
  ...
  cxDBLookupComboBox, cxDBLabel, uni, MemDS, DBAccess;
...
begin
  ...
  dxBtnGuardarMy.Enabled := edit and Estado;
  ...
  try
    ...
    try
      ...
      begin
        ...
        ModalRes := MsgBox.ShowModal('Confirmación', '¿Estás seguro que deseas eliminar el registro ['+ LocCampo +']?', cmtConfirmation, [cMbDelete, cMbNo], imagenAStream(campoImagen,zOtros) );
